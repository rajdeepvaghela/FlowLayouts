...
class FlowRadioGroup(context: Context, attrs: AttributeSet?) :
    ...
    private fun fetchAttrs(context: Context, attrs: AttributeSet?) {
        val typedArray = context.obtainStyledAttributes(attrs, R.styleable.FlowRadioGroup)
    ...
    override fun generateLayoutParams(p: ViewGroup.LayoutParams): LinearLayout.LayoutParams {
        return MarginLayoutParams(p) as LinearLayout.LayoutParams
    }

    override fun generateDefaultLayoutParams(): LinearLayout.LayoutParams {
        return MarginLayoutParams(super.generateDefaultLayoutParams()) as LinearLayout.LayoutParams
    }
